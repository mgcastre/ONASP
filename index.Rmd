...
output$MyMap <- renderLeaflet({
  ...
  leaflet(points01) %>%  
    ...
    # addFgb(file = "./data/flatgeobuff/watersheds.fgb", group = "Watersheds",
    #        stroke = TRUE, fill = FALSE, opacity = 1,
    #        color = "navy", weight = 3) %>%
    # addFgb(file = "./data/flatgeobuff/mainRivers.fgb", group = "Rivers",
    #        color = "dodgerblue", weight = 2,
    #        opacity = 1, popup = "LABEL") %>%
    # addFgb(file = "./data/flatgeobuff/geology.fgb", 
