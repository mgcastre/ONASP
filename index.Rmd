...
# Definr function for a download button
...
output$MyMap <- renderLeaflet({
  ...
  leaflet(points01) %>%  
    ...
    addPolygons(data = geology_ll, group = "Geology",
    ...
    addPolygons(data = watersheds_ll, group = "Watersheds",
                stroke = TRUE, fill = FALSE, opacity = 1,
                color = "navy", weight = 3) %>%
    addPolylines(data = rivers_ll, group = "Rivers",
